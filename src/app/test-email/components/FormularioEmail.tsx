...
interface FormularioEmailProps {
  deudorSeleccionado: DeudorConDatos | null
}
...
Le recordamos que tiene una deuda pendiente por un monto de ${deudorSeleccionado?.monto_deuda ? formatearMonto(deudorSeleccionado.monto_deuda) : '[Monto]'}.
...
Le informamos que su deuda de ${deudorSeleccionado?.monto_deuda ? formatearMonto(deudorSeleccionado.monto_deuda) : '[Monto]'} está próxima a vencer.
